...
// import VideoGeneratorUI from "./creator_VideoGeneratorUI.jsx";
// import ImageStudioUI from "./creator_ImageStudioUI.jsx";
// import WritingHubUI from "./creator_WritingHubUI.jsx";
...
function FileGrid({
  ...
  if (tab === "Video Generator") {
    ...
    return (
      <div>Video Generator (Coming Soon)</div>
    );
  }
  ...
  if (tab === "Image Studio") {
    const imageFiles = files.filter((f) => f.type === "Images");
    return (
      <div>Image Studio (Coming Soon)</div>
    );
  }
