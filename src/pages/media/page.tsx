        ...
        <div className="w-44 shrink-0 flex flex-col gap-3">
          <div className="glass rounded-xl border border-white/8 p-2 flex-1">
            ...
            {ALBUMS.map((a, i) => (
              <div
                key={a}
                className={`flex items-center gap-2 px-2 py-2 rounded-lg cursor-pointer transition-colors ${i === 0 ? "glass-crimson text-primary" : "text-white/40 hover:bg-white/5 hover:text-white/70"}`}
              >
                <Folder size={12} />
