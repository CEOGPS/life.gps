        ...
        <div className="flex gap-1 overflow-x-auto shrink-0">
          {TABS.map((t, i) => (
            <button
              key={t}
              onClick={() => setTab(i)}
              className={`px-3 py-1.5 rounded-lg text-[11px] font-display whitespace-nowrap transition-colors
          ...
          {METRICS.map((m) => (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[9px] font-display tracking-wider text-white/35">
                  {m.label.toUpperCase()}
                </span>
              </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="glass rounded-xl border border-white/8 overflow-hidden">
            <div className="p-3 border-b border-white/5 flex items-center justify-between">
              ...
              <button className="text-[9px] text-white/25 hover:text-primary/60 font-display">
                REQUEST REVIEW
              </button>
            </div>
            <div className="p-3 space-y-2">
              {REVIEW_PLATFORMS.map((p) => (
                <div
                  key={p.name}
                  className="flex items-center gap-2 py-1.5 hover:bg-white/4 rounded-lg px-2 cursor-pointer transition-colors"
                >
          ...
          <div className="glass rounded-xl border border-white/8 overflow-hidden">
            ...
            <div className="p-4 flex flex-col items-center justify-center min-h-[180px]">
              ...
              >
                Connect WordPress, GoDaddy, Brilliant Directories, etc.
              </div>
        ...
        <div className="glass rounded-xl border border-white/8 overflow-hidden">
          <div className="p-3 border-b border-white/5 flex items-center justify-between">
            ...
            <span className="text-[9px] text-white/25">
              Manage your presence across 50+ directories
            </span>
          </div>
          <div className="p-3 grid grid-cols-6 gap-2">
            {[
              ...
              <div
                key={l}
                className="glass rounded-lg p-2 border border-white/6 hover:border-primary/20 cursor-pointer transition-colors text-center"
              >
