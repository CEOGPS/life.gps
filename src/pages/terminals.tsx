...
export default function TerminalsPanel() {
  ...
  return (
    <PanelLayout
      title="Terminals"
      subtitle="All system terminals in one place"
    ...
    >
      <div className="h-full flex flex-col gap-0 glass rounded-xl border border-white/8 overflow-hidden">
        ...
        >
          {tabs.map((t) => (
            ...
            >
              <Terminal
                size={11}
                className={active === t ? "text-primary" : ""}
              />
          ...
          <button
            onClick={addTab}
            className="px-3 py-2.5 text-white/20 hover:text-primary transition-colors"
          >
            <Plus size={12} />
          </button>
          <button className="ml-auto px-3 py-2.5 text-white/20 hover:text-white/50">
            <Maximize2 size={12} />
          </button>
        </div>
        ...
        {/* Terminal area */}
        <div
          className="flex-1 p-4 font-mono text-xs text-emerald-400/70"
        ...
        >
          ...
          <div className="text-white/30 mt-1">
            Type commands here after wiring the terminal integration...
          </div>
