...
export const useGenerationStore = create(
  persist(
    (set, get) => ({
      ...
      voiceBlend: {},
      setVoiceBlend: (vt, value) =>
        set((state) => ({ voiceBlend: { ...state.voiceBlend, [vt]: value } })),
    ...
    {
      name: "veriton_generation_draft",
      partialize: (s) => ({
        mode: s.mode,
        lyrics: s.lyrics,
        genre: s.genre,
        genreSecondary: s.genreSecondary,
        genreBlendActive: s.genreBlendActive,
        genreBlend: s.genreBlend,
        mood: s.mood,
        delivery: s.delivery,
        gender: s.gender,
        voiceTypes: s.voiceTypes,
