      ...
      <div className="flex flex-col gap-4">
        <div className="flex gap-4">
          ...
          <div className="w-56 shrink-0 flex flex-col gap-3">
            ...
            <div className="glass rounded-xl border border-white/8 p-3 flex-1">
              <div className="flex items-center justify-between mb-2">
                ...
                <button className="text-[9px] text-white/20 hover:text-primary/60 font-display">
                  + NEW
                </button>
              </div>
              <div className="space-y-1.5">
                {SAVED_AREAS.map((a) => (
                  ...
                  >
                    ...
                    <button className="text-white/20 hover:text-primary/60 shrink-0">
                      <Trash2 size={9} />
                    </button>
                  </div>
                ))}
          ...
          >
            ...
            >
              <button className="text-white/30 hover:text-white/70 p-1 rounded transition-colors">
                <ZoomIn size={13} />
              </button>
              <button className="text-white/30 hover:text-white/70 p-1 rounded transition-colors">
                <ZoomOut size={13} />
