            ...
            <div className="flex items-center gap-2">
              <div className="flex gap-1.5">
                {["Personal", "Health", "Work", "Finance"].map((t) => (
                  <button
                    key={t}
                    className="flex items-center gap-1 text-[9px] px-2 py-0.5 rounded-full border border-white/8 text-white/25 hover:border-primary/30 hover:text-primary/50 transition-colors font-display"
                  >
                    <Tag size={8} /> {t}
                  </button>
                ))}
          ...
          <div className="glass rounded-xl border border-white/8 p-3 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[10px] text-white/20 mt-0.5">
                Journal data will be cross-referenced with your financial,
                health, and productivity data to surface insights.
              </div>
            </div>
          </div>
        </div>
