    ...
    <div style={{ padding: 24, background: "#0a0b12", borderRadius: 12 }}>
      ...
      >
        <button
          ...
          style={{
            ...
            borderRadius: 12,
            background:
              "linear-gradient(135deg, rgba(74,179,244,0.1), rgba(74,179,244,0.05))",
      ...
      >
        ...
        <div style={{ fontSize: 11, color: "#6aaedd", lineHeight: 1.8 }}>
          <div>
            • <strong>Editor:</strong> Brightness, contrast, saturation, blur,
            grayscale, sepia, invert, rotate, flip, text overlay
          </div>
          <div>
            • <strong>Generator:</strong> 5 modes (Realism, Cartoon, Watercolor,
            Abstract, 3D) with custom prompts
          </div>
          <div>
            • <strong>Auto-save:</strong> Images save to "Edited Images" or
            "Generated Images" albums
          </div>
          <div>
            • <strong>History:</strong> Undo/redo in editor
          </div>
        </div>
      </div>
    </div>
