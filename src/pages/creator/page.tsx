...
const TOOLS = [
  ...
  },
  {
    icon: <Video size={18} />,
    label: "Video Studio",
    desc: "Create & edit video content",
  },
  {
    icon: <FileText size={18} />,
    label: "Writing Studio",
    desc: "AI writing, scripts & editing",
  },
  {
    icon: <Wand2 size={18} />,
    label: "Voiceover Studio",
    desc: "Record, edit & generate voiceover",
  },
];
...
export default function CreatorPanel() {
  ...
  const [messages, setMessages] = usePersistentState<ChatMsg[]>(
    "creator_chat",
    [],
  );
  ...
  const handleSend = () => {
    ...
    setMessages((prev) => [
      ...
      {
        role: "assistant",
        text: "I'm your AI creative assistant. I'll help you generate content, brainstorm ideas, and build projects.",
      },
    ]);
    setChatInput("");
  };
                ...
                <div className="flex-1 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-white/30">
                      Ask AI to generate content, ideas, or scripts
                    </div>
                  </div>
                </div>
              ) : (
        ...
        <div className="w-52 shrink-0 flex flex-col gap-3">
          <div className="glass rounded-xl border border-white/8 p-3 flex-1 flex flex-col">
            ...
            <div className="text-[10px] text-white/40 leading-relaxed mb-3">
              Hyper-local feed for connections, collabs, and events in your
              area.
            </div>
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="text-[10px] text-white/30">
                  Connect location to see local creators
                </div>
              </div>
            </div>
          </div>
