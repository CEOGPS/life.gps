...
const MODES = [
  {
    ...
    name: "Realism",
    icon: "🏞️",
    desc: "Realistic landscapes and scenes",
    color: C.blue,
  },
  {
    id: "cartoon",
    name: "Cartoon",
    icon: "🎨",
    desc: "Bright cartoon illustrations",
    color: C.orange,
  },
  {
    id: "watercolor",
    name: "Watercolor",
    icon: "🎭",
    desc: "Soft watercolor paintings",
    color: C.pink,
  },
  {
    id: "abstract",
      ...
      >
          ...
          {MODES.map((m) => (
            <button
              ...
              style={{
                ...
                borderRadius: 8,
                background:
                  mode === m.id ? `${m.color}20` : "rgba(255,255,255,0.03)",
                border:
                  mode === m.id
        ...
        >
          <div style={{ fontSize: 10, color: "#6aaedd", lineHeight: 1.6 }}>
            Each mode generates unique art with different styles. Try different
            prompts and sizes for varied results.
          </div>
        </div>
      </div>
    </div>
