      ...
      <div className="h-full flex gap-4 overflow-y-auto">
        ...
        <div className="w-48 shrink-0 flex flex-col gap-3">
          <div className="glass rounded-xl border border-white/8 p-3">
            ...
            {PLATFORMS.map((p) => (
              <div
                key={p.name}
                className="flex items-center gap-2 py-1 hover:bg-white/5 rounded px-1 cursor-pointer group"
              >
                <span className="text-sm">{p.icon}</span>
                <span className={`text-[11px] flex-1 ${p.color}`}>
                  {p.name}
                </span>
          ...
          <div className="glass rounded-xl border border-white/8 p-3 space-y-2">
            ...
            {[
              ...
              <div key={s.label} className="flex items-center gap-1.5">
                ...
                <span className="text-[10px] text-white/80 font-display">
                  {s.val}
                </span>
              </div>
            ))}
        ...
        <div className="flex-1 flex flex-col gap-3 min-w-0">
          ...
          <div className="glass rounded-xl border border-white/8 p-4 flex flex-col gap-3 shrink-0">
            ...
            {/* Platform selector */}
            <div>
              <div className="text-[9px] text-white/35 font-display tracking-wider mb-2">
                POST TO:
              </div>
          ...
          <div className="flex-1 glass rounded-xl border border-white/8 flex items-center justify-center min-h-[180px]">
            <div className="text-center">
              ...
              <div className="text-sm text-white/55">
                Unified feed loads here
              </div>
              <div className="text-xs text-white/30 mt-1">
                Connect social accounts to see all posts in one feed
              </div>
            </div>
          </div>
        </div>
