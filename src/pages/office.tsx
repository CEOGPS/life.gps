      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-8 pl-8 text-xs rounded-lg text-white/80 placeholder:text-white/25 focus:outline-none transition-all"
            style={{
        ...
        <div className="glass rounded-xl border border-white/8 p-6 flex flex-col items-center justify-center min-h-[300px]">
          ...
          >
            Create a new document, spreadsheet, or import existing files
          </div>
          <button
        ...
        <div className="glass rounded-xl border border-white/8 p-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <button
                key={t}
                className="glass rounded-lg p-2.5 border border-white/6 hover:border-primary/20 text-left cursor-pointer transition-colors group"
              >
                <Folder size={12} className="text-primary/50 mb-1.5" />
                <div className="text-[10px] text-white/60 group-hover:text-white/90">
                  {t}
                </div>
              </button>
            ))}
