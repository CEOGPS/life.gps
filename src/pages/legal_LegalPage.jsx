        ...
        <div className="flex gap-1">
          {TABS.map((t, i) => (
            <button
              key={t}
              onClick={() => setTab(i)}
              className={`px-4 py-1.5 rounded-lg text-[11px] font-display tracking-wider transition-colors
          ...
          <div className="flex flex-col gap-4">
            {vaultLocked ? (
              ...
              >
                ...
                >
                  Unlock to access personal documents, media, and sensitive data
                </div>
                <button
              ...
              <>
                ...
                <div className="glass rounded-xl border border-white/8 p-6 flex flex-col items-center justify-center min-h-[200px]">
                  ...
                  <div
                    ...
                    style={{ color: "oklch(0.75 0.15 175 / 50%)" }}
                  >
                    Upload or create encrypted personal files
                  </div>
                </div>
              </>
            )}
            ...
            {vaultLocked ? (
              ...
              >
                ...
                <div
                  ...
                  style={{ color: "oklch(0.75 0.15 175 / 60%)" }}
                >
                  Maximum security storage. Eyes only.
                </div>
                <button
                  onClick={() => setVaultLocked(false)}
                  className="px-5 py-2 rounded-lg glass-crimson text-primary text-xs font-display hover:glow-crimson transition-all"
                ...
                {[
                  {
                    ...
                    desc: "Store credentials securely",
                  },
                  {
                    icon: <ShieldCheck size={14} />,
                    label: "Data Exposure Scan",
                    desc: "Check if your data is leaked",
                  },
                  {
                    icon: <EyeOff size={14} />,
                    label: "Private Files",
                    desc: "Encrypted file storage",
                  },
                  {
                    icon: <AlertTriangle size={14} />,
                    label: "Security Alerts",
                    desc: "Real-time breach notifications",
                  },
                ].map((i) => (
                  <div
                    key={i.label}
