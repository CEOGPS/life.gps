  ...
  return (
    <div className="flex items-center justify-center h-full min-h-[60vh]">
      ...
      >
        ...
        <h2 className="font-display text-lg text-white/80 tracking-wider mb-2">
          {name}
        </h2>
        <p className="text-sm text-white/30 leading-relaxed">
          {description ??
            "This panel is ready to be wired with integrations and live data."}
        </p>
        <div className="mt-6 flex items-center justify-center gap-2">
          <div className="w-2 h-2 rounded-full bg-primary/60 blink" />
          <span className="text-[10px] text-primary/60 font-display tracking-widest">
            COMING ONLINE
          </span>
        </div>
      </motion.div>
