...
description: Use when needing Desktop Commander MCP patterns: persistent shells, filesystem reach, edit_block, Excel/DOCX/PDF, SSH, long-running processes.
version: 1.0.0
...
metadata:
  hermes:
    ...
    related_skills: []
    source: C:/dev/.claude/skills/desktop-commander-overview
---
