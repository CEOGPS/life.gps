---
name: claude-autonomous-agentic-os-and-self-operating-computer-engineer
description: |
  An advanced systems skill for the Claude environment, focused on engineering Autonomous AI Agents that control web interfaces, desktop software, and local infrastructure.
