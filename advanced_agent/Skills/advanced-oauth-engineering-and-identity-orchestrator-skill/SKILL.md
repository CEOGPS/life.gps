...
description: |
  An advanced security engineering skill for the Claude. Emulates a Principal Security Engineer specializing in OAuth 2.0, OpenID Connect (OIDC), and modern identity protocols.
