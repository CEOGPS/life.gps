---
name: project-architecture-systems-opt
description: Use when auditing/refactoring project architecture: anti-patterns, performance, security, migration plans, scalability and DX optimization.
version: 1.0.0
...
metadata:
  hermes:
    ...
    related_skills: []
    source: C:/dev/.claude/skills/project-architecture-and-systems-optimization-engineer-skill
---
