---
name: advanced-oauth-identity
description: Use when designing/fixing OAuth 2.0/OIDC (Google, GitHub, Supabase, Microsoft, PKCE, token lifecycle, LifeOS dual OAuth lanes). Principal security/identity engineering.
version: 1.0.0
...
metadata:
  hermes:
    ...
    related_skills: []
    source: C:/dev/.claude/skills/advanced-oauth-engineering-and-identity-orchestrator-skill
---
