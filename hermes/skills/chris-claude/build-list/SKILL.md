---
name: build-list
description: Use when building structured contact/company lists from natural language criteria (titles, industry, size, location). Output clean tabular lists for CRM/outreach.
version: 1.0.0
...
metadata:
  hermes:
    ...
    related_skills: []
    source: C:/dev/.claude/skills/build-list
---
