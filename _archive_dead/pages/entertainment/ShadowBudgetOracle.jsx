  ...
  return (
    <span
      style={{
        ...
        padding: "1px 7px",
        borderRadius: 10,
        background: `${map[urgency]}20`,
        color: map[urgency],
        fontWeight: 700,
        border: `1px solid ${map[urgency]}30`,
      }}
    >
      {urgency}
    </span>
    ...
    >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 11, color: "#6aaedd" }}>
              Parallel financial realities · Ripple effects of everyday
              decisions
            </div>
          </div>
          {/* Summary chips */}
        ...
        {TABS.map((t) => (
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              whiteSpace: "nowrap",
              background: activeTab === t.id ? `${C.purple}20` : "transparent",
              color: activeTab === t.id ? C.purple : "#6aaedd",
              borderBottom:
                activeTab === t.id
                  ? `2px solid ${C.purple}`
                ...
                {editingBudget ? (
                  <>
                    <input
                      value={e.label}
                      onChange={(ev) =>
                        updateExpense(e.id, "label", ev.target.value)
                      }
                      style={{
                        ...inp,
                        flex: 1,
            ...
            {editingBudget && (
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewExpense((n) => ({ ...n, label: e.target.value }))
                  }
                  placeholder="Label"
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: 20 }}>
            ...
            >
              <div>
                ...
                >
                  Shadow Budget Scenarios
                </div>
                <div style={{ fontSize: 11, color: "#6aaedd" }}>
                  3 parallel financial realities from small changes to your
                  current budget
                </div>
              </div>
              <button
                onClick={genScenarios}
                disabled={scenLoading}
                style={btnP(C.purple)}
              >
            ...
            {scenarios.length === 0 && !scenLoading && (
              ...
              >
                ...
                >
                  Generate shadow scenarios to see 3 alternate financial
                  realities based on small changes to your current budget.
                </div>
              </div>
            )}
            ...
            {scenLoading && (
              <div
                style={{ textAlign: "center", padding: 40, color: C.purple }}
              >
                <div
                  style={{
                    fontSize: 36,
                ...
                >
                  ...
                  <div style={{ display: "flex", gap: 20 }}>
                    <div>
                      ...
                      <div
                        style={{ fontSize: 16, fontWeight: 800, color: C.blue }}
                      >
                        {fmt(monthlySurplus)}
                      </div>
                    </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: 20 }}>
          ...
          {scenarios.length === 0 ? (
            <div style={{ textAlign: "center", padding: 40, color: "#4a5568" }}>
              ...
              <div>
                Generate shadow scenarios first to see the ripple chart.
              </div>
              <button
                onClick={() => setActiveTab("shadow")}
                style={{ ...btnS(C.purple), marginTop: 12 }}
              >
                Go to Shadow View
              </button>
            </div>
                  ...
                  >
                    <div
                      style={{
                        ...
                        opacity: 0.8,
                        borderTop: `2px dashed ${SHADOW_COLORS[i]}`,
                      }}
                    />
                    <span style={{ fontSize: 11, color: SHADOW_COLORS[i] }}>
                      {s.name}
                    </span>
                  </div>
                ))}
                ...
                {scenarios.map((s, i) => (
                  <div
                    ...
                    style={{
                      ...card,
                      padding: 14,
                      border: `1px solid ${SHADOW_COLORS[i]}25`,
                    }}
                  >
                    <div
                      style={{
                    ...
                    >
                      ...
                      {fmt(Math.abs(s.month12 - monthlySurplus * 12))} vs
                      current
                    </div>
                  </div>
                ))}
      ...
      {activeTab === "decision" && (
        <div style={{ flex: 1, overflowY: "auto", padding: 20 }}>
          ...
          <div style={{ fontSize: 11, color: "#6aaedd", marginBottom: 20 }}>
            Enter any spending decision — see its 3-year ripple, family
            equivalent, and verdict
          </div>
      ...
      {activeTab === "oracle" && (
        <div style={{ flex: 1, overflowY: "auto", padding: 20 }}>
          ...
          <div style={{ fontSize: 11, color: "#6aaedd", marginBottom: 20 }}>
            Proactive ripple flags — tiny decisions with outsized long-term
            consequences
          </div>
          ...
          {!oracle && !oracleLoad && (
            <div style={{ textAlign: "center", padding: 60, color: "#4a5568" }}>
              ...
              >
                The Oracle scans your budget for invisible patterns and flags
                everyday decisions with outsized long-term ripple effects.
              </div>
            </div>
          )}
            ...
            <div style={{ maxWidth: 640 }}>
              ...
              {oracle.shadowSummary && (
                ...
                >
                  ...
                  <div
                    style={{ fontSize: 12, color: "#c8c8d0", lineHeight: 1.7 }}
                  >
                    {oracle.shadowSummary}
                  </div>
                </div>
