      ...
      <div className="h-full flex gap-4">
          ...
          <div className="grid grid-cols-7 gap-1 flex-1">
            {cells.map((day, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`flex items-center justify-center rounded-lg text-xs cursor-pointer transition-colors aspect-square
        ...
        <div className="w-64 shrink-0 flex flex-col gap-3">
          <div className="glass rounded-xl border border-white/8 p-3 flex-1 flex flex-col">
            <div className="text-[10px] text-white/30 font-display tracking-wider mb-3">
              UPCOMING
            </div>
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="text-[10px] text-white/12 mt-1">
                  Connect Calendly or add manually
                </div>
              </div>
            </div>
          </div>
