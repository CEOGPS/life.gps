    ...
    >
      <div className="h-full flex gap-4 overflow-y-auto">
        ...
        <div className="flex-1 flex flex-col gap-3 min-w-0">
          ...
          <div className="grid grid-cols-3 gap-3 shrink-0">
            {TOOLS.map((tool) => (
              <div
                key={tool.label}
                className="glass rounded-xl p-4 border border-white/10 hover:border-primary/30 cursor-pointer group transition-all hover:glow-crimson"
              >
                ...
                <div className="text-xs text-white/80 font-medium mb-1 group-hover:text-white transition-colors">{tool.label}</div>
          ...
          {/* Recent projects */}
          <div className="h-24 glass rounded-xl border border-white/10 flex flex-col overflow-hidden shrink-0">
            <div className="px-3 py-2 border-b border-white/5">
              <span className="text-[10px] font-display tracking-wider text-teal uppercase">Recent Projects</span>
            </div>
          ...
          {/* LLM Chat box */}
          <div className="flex-1 glass rounded-xl border border-white/10 flex flex-col overflow-hidden min-h-[220px]">
            <div className="px-3 py-2 border-b border-white/5 flex items-center gap-2 shrink-0">
              <Wand2 size={12} className="text-primary/60" />
              <span className="text-[10px] font-display tracking-widest text-teal uppercase">Generate</span>
            </div>
            ...
            <div className="p-3 border-t border-white/5 flex items-center gap-2 shrink-0">
              <input
                ...
                className="flex-1 h-8 px-3 text-xs bg-white/5 border border-white/10 rounded-lg text-white/80 placeholder:text-white/30 focus:outline-none focus:border-primary/40 transition-all"
              />
              <button
                onClick={handleSend}
        ...
        <div className="w-52 shrink-0 flex flex-col gap-3">
          <div className="glass rounded-xl border border-white/10 p-3 flex-1 flex flex-col">
            <div className="text-[9px] font-display tracking-widest mb-2 text-teal uppercase">Local Feed</div>
